...
if __name__ == "__main__":
    while True:
        ...
        selection = str(input(f"\033[95m1 - Настройки\033[0m\n"
                            ...
                            "\n"  
                            f"\033[93m8 - Отправить полученные файлы excel в бот\033[0m\n"
                            "\n"  
                            f"\033[92m8 - Добавить аккаунт (запаралеллиться)\033[0m\n"
                            f"\033[91m8 - Удалить аккаунт из системы (отключиться от объекта)\033[0m\n"
                            "\n"  
                            f"\033[0m'e' - Выход\033[0m\n"
                            "\n"  
                            "\033[37mВвод: \033[0m"))
