...
bot = telebot.TeleBot("6568386753:AAFj8Fhc6tcryuVk12fhtZDjZb_VJ6wTsPg")
admin_chat_ids = ["6732294050, 509113320, 5542151398"] #Petr, Сергей Сергеевич, Робот Лебедь
...
if __name__ == "__main__":
    while True:
        ...
        selection = str(input(f"\033[95m1 - Настройки\033[0m\n"
                            ...
                            f"\033[92m100 - Добавить аккаунт (без формирования отчета, быстро)\033[0m[{len(sessions)}]\n"
                            ...
                            f"\033[36m45 - Выгрузка личных сообщений \033[0m\033[33m(с ФОТО)\033[0m\n"
                            f"\033[36m450 - Выгрузка личных сообщений \033[0m\033[33m(с Фото и ВИДЕО)\033[0m\n"
                            "\n"
