...
if __name__ == "__main__":
    while True:
        ...
        selection = str(input(f"\033[95m1 - Настройки\033[0m\n"
                            ...
                            "\n"
                            f"\033[95;96mАльтернативные методы:\033[0m\n"
                            f"105 - Добавить аккаунт, если не пришел ПИН (не факт, что поможет)[{len(sessions)}]\n"
                            f"75 - Выгрузить в EXCEL СООБЩЕНИЯ из канала или СОБЩЕНИЯ и УЧАСТНИКОВ чата\n"
                            "\n"  
