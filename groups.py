                ...
                if 0 <= i < len(sessions):
                    ...
                    while True:
                        ...
                        for openchannel in openchannels:
                            ...
                            print(f"{oc} - {openchannel.title} {chat.participants_count}\033[91m{owner} {admin}\033[0m ID:{openchannel.id} @{openchannel.username}")
                            oc += 1
                            if owner !="" or admin != "":
                                owner_channel += 1
                        ...
                        for closechannel in closechannels:
                            ...
                            print(f"{cc} - {closechannel.title} {chat.participants_count} \033[91m{owner} {admin}\033[0m ID:{closechannel.id}")
                            cc += 1
                            if owner !="" or admin != "":
                                owner_channel += 1
                        ...
                        for openchat in openchats:
                            ...
                            print(f"{og} - {openchat.title} {chat.participants_count}\033[91m{owner} {admin}\033[0m ID:{openchat.id} @{openchat.username}")
                            og += 1
                            if owner !="" or admin != "":
                                owner_group += 1
                        ...
                        for closechat in closechats:
                            ...
                            print(f"{cg} - {closechat.title} {chat.participants_count}\033[91m{owner} {admin}\033[0m ID:{closechat.id}")
                            cg += 1
                            if owner !="" or admin != "":
                                owner_group += 1
                                owner_closegroup += 1
