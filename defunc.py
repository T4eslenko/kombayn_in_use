        ...
        for message in client.iter_messages(target_user):
            ...
            if message.forward:
                ...
                try:
                    ...
                    forward_sender_parts = [part for part in [forward_username, forward_first_name, forward_last_name] if (isinstance(part, str) and part.strip() != "") or isinstance(part, int)]
