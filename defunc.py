...
def config(api_id, api_hash):
    while True:
        ...
        prompt_message = (
            f"\033[35m1 - Обновить api_id [{options[0].rstrip()}]\033[0m\n"
            f"\033[35m2 - Обновить api_hash [{options[1].rstrip()}]\033[0m\n"
            "\033[31m3 - Сбросить настройки\033[0m\n"
            " \n"
            f"\033[37m4 - Парсить user-id [{options[2].rstrip()}]\033[0m\n"
            f"\033[37m5 - Парсить user-name [{options[3].rstrip()}]\033[0m\n"
            " \n"
            "\033[4m\033[36mРабота с аккаунтами\033[0m\033[0m\n"
            f"\033[36m6 - Вывести список подключенных аккаунтов. Сейчас: [{len(sessions)}]\033[0m\n"
            f"\033[36m7 - Добавить новый аккаунт. Сейчас: [{len(sessions)}]\033[0m\n"
            f"\033[36m8 - Завершить сеанс аккаунта в системе. Сейчас: [{len(sessions)}]\033[0m\n"
            " \n"
