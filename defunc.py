...
def type_of_channel(delgroups, chat_message_counts, openchannels, closechannels, openchats, closechats):
             owner_channel = 0
             owner_group = 0
             owner_closegroup = 0
             ...
             for delgroup in delgroups:
            	 ...
            	 if owner !="" or admin != "":
            		 owner_group += 1
            		 owner_closegroup += 1                    
             return all_info, openchannel_count, closechannel_count, opengroup_count, closegroup_count, closegroupdel_count
